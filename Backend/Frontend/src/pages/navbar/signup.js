...
const handleSubmit = async (e) => {
	...
	const res = await fetch("/signup" , {
		...
		body : JSON.stringify({
			name : name ,email ,mobile ,password ,cpassword
		}) 
	}) ;
		...
		>
			...
			<div className="bt">
				<button
					...
					htmlType="submit"
					className="btn1"
					style={{ marginTop: "30px", display: 'flex',alignItems: 'center', justifyContent: 'center', fontSize: '20px', height: '2.2em', width: '12em'}}
