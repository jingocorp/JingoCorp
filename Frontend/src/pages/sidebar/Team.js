...
return (
	<div className="team">
       ...
       <div id='mem1' className="member1">
		...
		<h1> Shivendra <br/>
		<a  href='https://www.linkedin.com/in/shivendra-giri-789216191/' target="_blank">
		...
		<h1> Rishav <br/>
		<a  href='https://www.linkedin.com/in/rishavadarsh/' target="_blank">
		<LinkedinFilled className="linkedin"/>
		</a>
		<a  href='https://www.instagram.com/ris_adrsh/' target="_blank">
		<InstagramOutlined className="instagram"/>
		</a>
		<a  href='https://www.facebook.com' target="_blank">
		<FacebookFilled className="facebook"/>
		...
		<FacebookFilled className="facebook"/>
		 ...
		 <div className='shiv'>
		 <h1>Shivendra <h4>(Front-End Lead)</h4> </h1>
		 <p>
			<ul>
				<li>ReactJs</li>
				<li>JSX</li>
		...
		<div className='ris'>
		 <h1>Rishav <h4>(Back-End Lead)</h4> </h1>
		 <p>
			<ul>
				<li>ReactJs</li>
				<li>ExpressJs</li>
		...
		<div className='pri'>
		 <h1>Priyam <h4>(Back-End Lead)</h4> </h1>
		 <p>
			<ul>
				<li>ReactJs</li>
				<li>ExpressJs</li>
